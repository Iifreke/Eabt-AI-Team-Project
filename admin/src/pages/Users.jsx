            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {stat.conversations.map(c => {
                  const cfg = STATUS_CONFIG_CONV[c.status] || STATUS_CONFIG_CONV.resolved;
                  return (
                ...
                return (
                  ...
                  >
                    ...
                    <div className="grid grid-cols-3 gap-2 text-center">
                      ...
                      <div>
                        <div className="text-xl font-bold text-green-600">{stat.resolved}</div>
